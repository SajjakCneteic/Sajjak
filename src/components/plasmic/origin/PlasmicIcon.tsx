...
import sty from "./PlasmicIcon.module.css"; // plasmic-import: ppX7-dDbM1AF/css

import Icon14Icon from "./icons/PlasmicIcon__Icon14"; // plasmic-import: faSNjLcBaqtF/icon
...
function PlasmicIcon__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox___2GnWk)}>
        {renderPlasmicSlot({
          defaultContents: (
            <Icon14Icon
              className={classNames(projectcss.all, sty.svg__hpEhX)}
              role={"img"}
            />
          ),
      ...
      <div className={classNames(projectcss.all, sty.freeBox__zKhOy)}>
        {renderPlasmicSlot({
          defaultContents: (
            <div
              className={classNames(
