...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: I5js4PhjVC86/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__rijw6)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__uwZOo)}
              role={"img"}
            />
          ),
