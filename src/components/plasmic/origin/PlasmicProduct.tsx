...
import sty from "./PlasmicProduct.module.css"; // plasmic-import: qDMzNhCj4r2d/css
...
function PlasmicProduct__RenderFunc(props: {
  ...
  return (
    <Stack__
      ...
      platform={"react"}
    >
      <div className={classNames(projectcss.all, sty.freeBox___4Svyi)}>
        {renderPlasmicSlot({
          defaultContents: (
            <ProductMedia
              className={classNames("__wab_instance", sty.productMedia___7PlC)}
            />
          ),
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__wfzNd)}
      >
        <h3
